...
rCode <- OhdsiRTools::createArgFunction("getDbCaseCrossoverData",
                                        excludeArgs = c("connectionDetails",
                                                        ...
                                                        "exposureIds"),
                                        rCode = rCode)
rCode <- OhdsiRTools::createArgFunction("selectSubjectsToInclude",
                                        excludeArgs = c("caseCrossoverData", "outcomeId"),
                                        rCode = rCode)
rCode <- OhdsiRTools::createArgFunction("getExposureStatus",
